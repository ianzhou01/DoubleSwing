...
export function makeReadoutUpdater({ ui, params, engine, getDragging }) {
    return function updateReadout() {
        ...
        ui.readout.textContent = `L1=${params.l1.toFixed(2)}  L2=${params.l2.toFixed(
            2
        )}  M1=${params.m1.toFixed(2)}  M2=${params.m2.toFixed(2)}
...
Currently dragging: ${dragging === 1 ? "Bob 1" : dragging === 2 ? "Bob 2" : "none"}`;
    };
}
